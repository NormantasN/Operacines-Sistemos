    ...
    public void execute() {
        ...
        switch (step) {
            case 1:
                ...
                kernel.requestResource(this, "VARTOTOJO_ATMINTIES_BLOKAS");
                step = 2;
                break;

            case 2:
                Logger.log("[JobGovernor] Creating page table and loading program");
                kernel.requestResource(this, "PUSLAPIU_LENTELE");
                kernel.requestResource(this, "UZDUOTIS_SUPERVIZORINEJE_ATMINTYJE");
            ...
            case 5:
                ...
                boolean isIO = false; // tarkim sprendžiam pertraukimo turinį
            ...
            case 6:
                ...
                kernel.requestResource(this, "NEEGZISTUOJANTIS_RESURSAS");
                break;
        }
    }
}
